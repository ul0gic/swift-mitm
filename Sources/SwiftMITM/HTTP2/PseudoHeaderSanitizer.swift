...
enum HeaderSanitizationError: Error, Equatable, Sendable {
...
struct SanitizedRequestLine: Sendable, Equatable {
    let method: String
    let scheme: String
